...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <a class="underline text-sm text-gray-600 hover:text-blue-600 rounded-md focus:outline-none" href="<?php echo e(route('register')); ?>">
                Belum punya akun?
            </a>
        </div>
        ...
        <div class="flex items-center justify-between mt-6 pt-2 border-t border-gray-100">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-500 hover:text-gray-900 rounded-md focus:outline-none" href="<?php echo e(route('password.request')); ?>">
                    Lupa password?
                </a>
            <?php else: ?>
                <div></div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\bengkel-maju-motor\resources\views/auth/login.blade.php ENDPATH**/ ?>